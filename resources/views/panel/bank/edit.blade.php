...
@section('page-title'){{ trans('general.page-titles.groups.edit') }}@endsection
            ...
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-md-8">
                                <form method="post" data-type="ajax-form" action="{{ route('panel.banks.update' , $bank->id) }}">
                                    @csrf
                                    @method('patch')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="code" name="code" value="{{ $bank->code }}">
                                    </div>
