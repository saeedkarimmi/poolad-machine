...
@section('page-title'){{ trans('general.page-titles.roles.create') }}@endsection
            ...
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-md-8">
                                <form method="post" data-type="ajax-form" action="{{ route('panel.roles.store') }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        @foreach($permissions as $id => $permission)
                                            <div class="i-checks">
                                                <label> <input type="checkbox" name="permissions[]" value="{{ $id }}"> <i></i> {{ trans('permission.' . $permission) }} </label>
                                            </div>
                                        @endforeach
                                    </div>
