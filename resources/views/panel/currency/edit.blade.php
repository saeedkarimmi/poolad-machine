...
@section('page-title'){{ trans('general.page-titles.currency.edit') }}@endsection
            ...
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-md-8">
                                <form method="post" data-type="ajax-form" action="{{ route('panel.currencies.update' , $currency->id) }}">
                                    @csrf
                                    @method('patch')
