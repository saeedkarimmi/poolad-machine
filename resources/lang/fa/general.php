...
return [
    'message' => [
        ...
        'accept' => [
            'success' => 'تایید درخواست تسویه با موفقیت ایجاد شد'
        ],
        'update' => [
            'success' => 'ویرایش با موفقیت انجام شد',
            'error'   => 'ویرایش با خطا مواجه شد'
        ],
        'delete' => [
    ...
    'page-titles' => [
        ...
        'groups' => [
            ...
            'index' => 'گروه های کاربری',
            'edit' => 'ویرایش گروه کاربری',
        ],
        'banks' => [
            'create' => 'ایجاد بانک جدید',
            'index' => 'بانک ها',
            'edit' => 'ویرایش بانک',
        ],
        'currency' => [
            'create' => 'ایجاد ارز جدید',
            'index' => 'ارزها',
            'edit' => 'ویرایش ارز',
        ],
        'container' => [
            'create' => 'ایجاد کانتینر جدید',
            'index' => 'کانتینرها',
            'edit' => 'ویرایش کانتینر',
        ],
        'spiral' => [
            'create' => 'ایجاد مارپیچ جدید',
            'index' => 'مارپیچ ها',
            'edit' => 'ویرایش مارپیچ',
        ],
        'seller' => [
            'create' => 'ایجاد فروشنده جدید',
            'index' => 'فروشنده ها',
            'edit' => 'ویرایش فروشنده',
        ],
        'order' => [
        ...
        'system-control' => [
            'create' => 'ایجاد کنترل جدید',
            'index' => 'کنترل ها',
            'edit' => 'ویرایش کنترل',
        ],
        'machine-model' => [
            'create' => 'ایجاد مدل دستگاه جدید',
            'index' => 'مدل های دستگاه',
            'edit' => 'ویرایش مدل دستگاه',
        ],
    ],
    'profile' => 'پروفایل',
    'logout' => 'خروج',
