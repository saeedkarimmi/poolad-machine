...
{
    protected $appendsJalaliByDefault;
    protected $jalaliPrefix;
    protected $jalaliDateFormat;
...
//    public function getJalaliTimestamp($attribute = 'created_at' , $format = 'Y/m/d'){
//        $this->setJalaliFormat($format);
//        $attr = 'jalali_'.$attribute;
//        return $this->$attr;
//    }
}
