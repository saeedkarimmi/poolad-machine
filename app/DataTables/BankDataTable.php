...
class BankDataTable extends BaseDataTable implements DatabaseInterface
{
        ...
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                return sprintf('<a href="%s" title="%s"><i class="fa fa-edit text-navy"></i></a>',
                    route('panel.banks.edit', $row->id), __('general.form.edit'));
            });
    }
    ...
    public function getColumns()
    {
        return [
            ...
            Column::make('code')->title(trans('validation.attributes.code')),
    ...
    protected function getBuilderParameters()
    {
        ...
        array_unshift($params['buttons'], [
            'text' => 'ایجاد بانک جدید',
            'className' => 'action',
            'action' => 'function(e, dt, node, config) { var u = "' . route('panel.banks.create') . '"; window.location.href = u; }'
        ]);
        return $params;
    }
}
